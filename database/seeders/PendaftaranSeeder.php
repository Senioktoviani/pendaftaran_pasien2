...
class PendaftaranSeeder extends Seeder
{
    ...
    public function run()
    {
        $pendaftaran1 = Pendaftaran::create(['nama_pasien' => 'Seni', 'id_keluhan' => 1,
            ...
            'jk' => 'Perempuan', 'jadwal_periksa' => 'Jam 11', 'id_ruang' => 1, 'cara_bayar' => 'BPJS']);
        ...
        $pendaftaran2 = Pendaftaran::create(['nama_pasien' => 'Senisen', 'id_keluhan' => 2,
            ...
            'jk' => 'Perempuan', 'jadwal_periksa' => 'Jam 09', 'id_ruang' => 2, 'cara_bayar' => 'UMUM']);
        ...
        $pendaftaran3 = Pendaftaran::create(['nama_pasien' => 'Dikri', 'id_keluhan' => 1,
            ...
            'jk' => 'Laki-laki', 'jadwal_periksa' => 'Jam 13', 'id_ruang' => 3, 'cara_bayar' => 'BPJS']);
